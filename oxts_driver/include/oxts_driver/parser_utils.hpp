...
#ifndef OXTS_DRIVER__PARSER_UTILS
#define OXTS_DRIVER__PARSER_UTILS
...
#include <oxts_driver/nav_conversions.hpp>

/**
 * Functions to decode NCom 
 */
namespace lib_oxts {
...
#endif // OXTS_DRIVER__PARSER_UTILS
